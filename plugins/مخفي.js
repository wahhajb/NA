...
await conn.relayMessage(m.chat, {extendedTextMessage:{text: `${masss}\n${htextos}\n`, ...{ contextInfo: { mentionedJid: users, externalAdReply: { thumbnail: imagen1, sourceUrl: 'https://chat.whatsapp.com/BzJhdxwVlte1unMYgieoYQ' }}}}}, {})
}}}
handler.command = /^(hidetag|مخفي|وهمي)$/i
handler.group = true
handler.admin = true
