...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,`للاسف الملف أكثر من ${limit} ميغابايت، تم إلغاء التنزيل.`, m).then(_ => m.react('✖️'))
...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,`للاسف الملف أكثر من ${limit} ميغابايت، تم إلغاء التنزيل.`,  m, fake,).then(_ => m.react('✖️'))
...
if (size.split('MB')[0] >= limit) return conn.reply(m.chat,`للاسف الملف أكثر من ${limit} ميغابايت، تم إلغاء التنزيلa.`,  m, fake,).then(_ => m.react('✖️'))
