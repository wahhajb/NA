...
const handler = async (m, {conn, args, command, usedPrefix}) => {
  if (!args[0]) throw `_*حط رابط من الانستا.*\n\n*[ 🎴 ] مثال:* _${usedPrefix + command} هنا الرابط_`;
  m.reply(wait);
  m.react(rwait)
  try {
      ...
      try {
        ...
        try {
          ...
          try {
            ...
            throw `_*❌ حصل خطاء في التحميل ، حاول لاحقاً_*`;
          }
        }
      }
    }
...
handler.command = /^(انستقرام|انستا|انستغرام|igdl|ig|instagramdl2|instagram2|igdl2|ig2|instagramdl3|instagram3|igdl3|ig3)$/i;
