...
if (command == 'rata') {
conn.reply(m.chat, `
_*${text.toUpperCase()}* *ES* *${(500).getRandom()}%* *${command.replace('how', '').toUpperCase()} 🐁 كل جبن 🧀*_
`.trim(), m, m.mentionedJid ? {
mentions: m.mentionedJid
} : {})}
...
handler.command = /^ورع|اهبل|خروف|جميل|puto|puta|manco|manca|rata|prostituta|prostituto/i
