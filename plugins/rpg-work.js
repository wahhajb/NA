...
global.work = ["مطور مواقع ويب", "مطور العاب", "احد مطورين هنري بوت 🌚", "مساعد تنسيق في هنري بوت", "مساعد مشرف علي مجموعات صاصا و هنري", "مطور العاب", "عملت في منجم", "منظم حفلات من اجل الحصول علي",
...
"تنضم لفريق هنري والحزا *ES* وتحصل علي", "لقد صممت شعار تيم هنري و صاصا *ES* وحصلت علي", 
"لقد قمت بالاشراف علي مجموعه *ES* عندما لم يكن موجود تفوز ب ", 
"لقد عمل بأفضل ما لديه في شركة طباعة كانت توظف وحصلت علي", 
"احد افراد تيم هنري و صاصا *ES*", "لقد زاد الطلب على ألعاب الأجهزة المحمولة ، لذا يمكنك إنشاء لعبة جديدة مليئة بالمعاملات الصغيرة. مع لعبتك الجديدة تكسب", 
