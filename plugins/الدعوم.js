...
│ *=> ✅ البوت عام للجميع*
│ *=> 👑 تم تطويري بواسطة سينتشي*
│ *=> 🔗 رقم المطور:* *https://wa.me/+905360504045*
╰────────────────`.trim()
...
let _uptime = process.uptime() * 1000
let uptime = clockString(_uptime)    
throw `*🤖 وقت العمل: ${uptime} ┃ 👑 بواسطة سينتشي ┃ 🔗 قروب الدعم:*https://chat.whatsapp.com/IqinkrUsBHzCWX8DdvUHLv*`}}
handler.help = ['estado']
handler.tags = ['main']
